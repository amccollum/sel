...
(function(sel) {
  /* util.coffee
  */
  var attrPattern, checkNth, combinatorPattern, combine, contains, create, eachElement, elCmp, evaluate, extend, filter, filterDescendants, find, findRoots, html, matchesDisconnected, matchesSelector, matching, name, nextElementSibling, normalizeRoots, nthPattern, outerParents, parentMap, parse, parseSimple, pseudoPattern, qSA, select, selectorGroups, selectorPattern, synonym, tagPattern, takeElements, _attrMap, _positionalPseudos, _ref;
  ...
  */
  ...
  return sel.matching = matching = function(els, selector, roots) {
